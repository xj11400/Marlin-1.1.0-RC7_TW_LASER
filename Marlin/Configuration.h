...
//M902: Laser Driver Power OFF
 ...
 >若要使用自己的configuration.h (也要是Marlin 1.1.0-RC7的 沒測試過其他版本可不可以)
 >只要在裡面加上 #define LASER_CONTROL 以及語言改為 tw 既可)
 >#define LCD_LANGUAGE tw //這一行en改tw



Origin Marlin:1.1.0-RC7 [https://github.com/MarlinFirmware/Marlin]
*/
...
//    kana, kana_utf8, nl, pl, pt, pt_utf8, pt-br, pt-br_utf8, ru, test, tw
//
// :{'en':'English','an':'Aragonese','bg':'Bulgarian','ca':'Catalan','cn':'Chinese','cz':'Czech','de':'German','el':'Greek','el-gr':'Greek (Greece)','es':'Spanish','eu':'Basque-Euskera','fi':'Finnish','fr':'French','gl':'Galician','hr':'Croatian','it':'Italian','kana':'Japanese','kana_utf8':'Japanese (UTF8)','nl':'Dutch','pl':'Polish','pt':'Portuguese','pt-br':'Portuguese (Brazilian)','pt-br_utf8':'Portuguese (Brazilian UTF8)','pt_utf8':'Portuguese (UTF8)','ru':'Russian','test':'TEST','tw':'Chinese(TAIWAN)'}
//
